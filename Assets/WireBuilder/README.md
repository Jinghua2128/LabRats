...
WireBuilder is a tool that allows you to create wires from the Unity Editor.
    ...
    /// Set the layer "wire" inn the prefabs EndAnchor, segment, segmentNoPhysics, StartAnchor, WireBuilder. Change childrens as well. 
    /// Do not change plug layer. 
    /// 
    /// If you use URP add layer "wire" to URP Renderer Data > Filterig.
    /// 
