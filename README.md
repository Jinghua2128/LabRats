...
A VR educational experience built with Unity and the XR Interaction Toolkit, where players explore scientific experiments in an immersive laboratory environment.
...
#### Movement
- **Move**: Use the joystick/thumbstick to move around the environment
- **Turn**: Use snap turn to rotate your view
...
#### Gravity Lab
- Move sliders to change gravity and height parameters
...
### Liu GuangXuan
- Main game flow coding (fixing bugs, refining flow)
- Main ITD coder
...
| Role | Member | Team Code |
|------|--------|-----------|
| Main Coder | Liu GuangXuan | G²KM |
| Secondary Coder | Ng Kiang Hwee | G²KM |
| Main Assets | Arai Mio Ashley | G²KM |
| Main UI/UX Documentation | Gracie Arianne Peh | G²KM |

---

**Developed by G²KM Studio**
